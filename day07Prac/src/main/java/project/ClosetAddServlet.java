...
@WebServlet("/addCloset")
public class ClosetAddServlet   extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if( result != null) {
			...
			ArrayList<String> closetList   =  new ArrayList<String> ();
			closetList.add(name);
			
			
			//세션저장소에 저장하기
			session.setAttribute("closetList" , closetList);
